		...
		<?php while ( $recent_posts->have_posts() ) : $recent_posts->the_post(); ?>
			<div class="post-item">
				...
				<div class="post-info">
					...
					<?php
						$excerpt = 'Dilek, şikayet ve önerileriniz bizler için önemlidir.';
						echo '<p>' . pizzaro_custom_excerpt( $excerpt, 25 ) . '</p>';
					?>

					<?php if ( isset( $show_read_more ) && $show_read_more ) : ?>
						<a id="store-locator" class="btn-more" href="http://dev.italianafabbrica.com/bize-ulasin"><?php echo wp_kses_post( __( 'Bize Ulaşın', 'pizzaro' ) ); ?></a>
					<?php endif; ?>
