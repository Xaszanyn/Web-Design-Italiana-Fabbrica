	...
	function pizzaro_footer_contact_form() {
		...
		<form action="post">
			<div class="form-group">
				<label for="yourName"><?php echo esc_html__( 'İsim', 'pizzaro' ); ?></label>
				<input type="text" class="form-control" id="yourName" placeholder="<?php echo esc_attr( esc_html__( 'İsim', 'pizzaro' ) ); ?>">
			</div>
			<div class="form-group">
				<label for="emailAddress"><?php echo esc_html__( 'Email Adres', 'pizzaro' ); ?></label>
				<input type="email" class="form-control" id="emailAddress" placeholder="<?php echo esc_attr( esc_html__( 'Email Adres', 'pizzaro' ) ); ?>">
			</div>
			<div class="form-group">
				<label for="yourMessage"><?php echo esc_html__( 'Mesaj', 'pizzaro' ); ?></label>
				<textarea rows="10" cols="10" class="form-control" id="yourMessage" placeholder="<?php echo esc_attr( esc_html__( 'Mesaj', 'pizzaro' ) ); ?>"></textarea>
			</div>
			<div class="text-center"><button type="submit" class="btn btn-default button"><?php echo esc_html__( 'Gönder', 'pizzaro' ); ?></button></div>
		</form>
		<?php
