		...
		'fl'	=> array(
			...
			'features'			=> array(
				array(
					...
					'label'	=> sprintf( '<h4>%s</h4><p>%s</p>', esc_html__( 'En Kaliteli Ürünler', 'pizzaro' ), esc_html__( 'Fabbrica en taze ve sağlıklı ürünleri sizler için bir araya getirir.', 'pizzaro' ) ),
				),
				array(
					'icon'	=> 'po po-on-time',
					'label'	=> sprintf( '<h4>%s</h4><p>%s</p>', esc_html__( 'Zamanında', 'pizzaro' ), esc_html__( 'Siparişleriniz tam zamanında kapınızda.', 'pizzaro' ) ),
				),
				array(
					'icon'	=> 'po po-master-chef',
					'label'	=> sprintf( '<h4>%s</h4><p>%s</p>', esc_html__( 'En iyi şefler', 'pizzaro' ), esc_html__( 'Türkiyenin en iyi şefleri Fabbricada.', 'pizzaro' ) ),
				),
				array(
					'icon'	=> 'po po-ready-delivery',
					'label'	=> sprintf( '<h4>%s</h4><p>%s</p>', esc_html__( 'Lezzetli', 'pizzaro' ), esc_html__( 'Birbirinden leziz ürünlerimiz sizleri bekliyor.', 'pizzaro' ) ),
				)
			)
		)
	);
