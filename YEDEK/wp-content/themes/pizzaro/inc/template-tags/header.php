			...
			<nav id="site-navigation" class="main-navigation" role="navigation" aria-label="<?php esc_html_e( 'Primary Navigation', 'pizzaro' ); ?>">
				...
				<div class="handheld-navigation">
					...
					wp_nav_menu( apply_filters( 'pizzaro_handheld_menu_args', array(
						...
						'container'			=> false,
						'fallback_cb'		=> 'pizzaro_nav_menu_fallback',
						'items_wrap'		=> '<span class="phm-close">' . apply_filters( 'pizzaro_handheld_menu_close_button_text', esc_html__( 'Menüyü Kapat', 'pizzaro' ) ) . '</span><ul id="%1$s" class="%2$s">%3$s</ul>'
					) ) );
					?>
				</div>
	...
	function pizzaro_header_phone() {
		...
		<div class="header-phone-numbers">
			<div class="header-phone-numbers-wrap">
				...
				<select class="select-city-phone-numbers selectpicker" style="color: ##ffffff;
    opacity: 0.7;
    border: 2px solid;
    border-radius: 25px;" name="city-phone-numbers" id="city-phone-numbers">
