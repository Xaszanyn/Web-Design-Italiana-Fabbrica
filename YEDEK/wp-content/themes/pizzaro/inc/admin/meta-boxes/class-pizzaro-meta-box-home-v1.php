			...
			<div id="features_list" class="panel pizzaro_options_panel">
				...
				<?php
					...
					pizzaro_wp_textarea_input( array(
						...
						'value'			=> isset( $home_v1['fl']['features'][0]['label'] ) ? $home_v1['fl']['features'][0]['label'] : sprintf( '<h4>%s</h4><p>%s</p>', esc_html__( 'En Kaliteli Ürünler', 'pizzaro' ), esc_html__( 'Fabbrica en taze ve sağlıklı ürünleri sizler için bir araya getirir.', 'pizzaro' ) ),
					) );
				?>
				</div>
				...
				<?php
					...
					pizzaro_wp_textarea_input( array(
						...
						'value'			=> isset( $home_v1['fl']['features'][1]['label'] ) ? $home_v1['fl']['features'][1]['label'] : sprintf( '<h4>%s</h4><p>%s</p>', esc_html__( 'Zamanında', 'pizzaro' ), esc_html__( 'Siparişleriniz tam zamanında kapınızda.', 'pizzaro' ) ),
					) );
				?>
				</div>
				...
				<?php
					...
					pizzaro_wp_textarea_input( array(
						...
						'value'			=> isset( $home_v1['fl']['features'][2]['label'] ) ? $home_v1['fl']['features'][2]['label'] : sprintf( '<h4>%s</h4><p>%s</p>', esc_html__( 'En iyi şefler', 'pizzaro' ), esc_html__( 'Türkiyenin en iyi şefleri Fabbricada', 'pizzaro' ) ),
					) );
				?>
				</div>
				...
				<?php
					...
					pizzaro_wp_textarea_input( array(
						...
						'value'			=> isset( $home_v1['fl']['features'][3]['label'] ) ? $home_v1['fl']['features'][3]['label'] : sprintf( '<h4>%s</h4><p>%s</p>', esc_html__( 'Lezzetli', 'pizzaro' ), esc_html__( 'Birbirinden leziz ürünlerimiz sizleri bekliyor.', 'pizzaro' ) ),
					) );
				?>
				</div>
